...
class VillageController extends Controller
{
    ...
    public function edit($id)
    {
        $vil = Village::find($id);
        $states = State::all();
        $districts = District::where('state_id',$vil->state_id)->get();
        $talukas = Taluka::where('district_id',$vil->district_id)->get();
        if($vil->cluster_id != null)
            $clusters = Cluster::where('taluka_id',$vil->taluka_id)->get();
